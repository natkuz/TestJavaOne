...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        assertThat(Calculator.calculatingDiscount(110.2, 10)).isEqualTo(99.18);
        assertThatThrownBy( () -> Calculator.calculatingDiscount(0, 10)
            ).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy( () -> Calculator.calculatingDiscount(110, 0)
            ).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy( () -> Calculator.calculatingDiscount(-100, 10)
            ).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy( () -> Calculator.calculatingDiscount(110, -1)
            ).isInstanceOf(ArithmeticException.class);
    }
}